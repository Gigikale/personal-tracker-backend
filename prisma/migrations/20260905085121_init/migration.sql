...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('BUDGET_THRESHOLD', 'RECURRING_EXPENSE', 'SYSTEM');
...
-- CreateIndex
CREATE INDEX "recurring_expenses_nextRunDate_isActive_idx" ON "recurring_expenses"("nextRunDate", "isActive");

-- CreateIndex
CREATE INDEX "recurring_expenses_deletedAt_idx" ON "recurring_expenses"("deletedAt");
